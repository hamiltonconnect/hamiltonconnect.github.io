            ...
            if (p.test(h)) {
                ...
                e.ajax({
                    ...
                    if (e.status == "success") {
                        ...
                        $(".message").html('<p class="notify-valid">Congrats! You are on the list.<br>Keep an eye on your inbox for the lastest opportunities.</p>').fadeIn();
                        i.val() = "";
                    } else {
